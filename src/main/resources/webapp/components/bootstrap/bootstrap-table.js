...
!function ($) {
    ...
    BootstrapTable.prototype.initContainer = function () {
        this.$container = $([
            ...
            '<div class="fixed-table-loading" style="padding-top:6px;padding-bottom:24px;">',
    ...
    BootstrapTable.prototype.initBody = function (fixedScroll) {
            ...
            $.each(this.header.fields, function (j, field) {
                ...
                if (column.checkbox || column.radio) {
                    ...
                    text = [that.options.cardView ?
                        '<div class="poker-views">' : '<td class="bs-checkbox">',
                            '<input' +
                            sprintf(' data-index="%s"', i) +
        ...
        this.$body.find('> tr > td > .detail-icon').off('click').on('click', function () {
            ...
            if ($tr.next().is('tr.detail-views')) {
                ...
                $tr.after(sprintf('<tr class="detail-views"><td colspan="%s">%s</td></tr>',
        ...
        $.each(this.header.events, function (i, events) {
            ...
            for (var key in events) {
                that.$body.find('tr').each(function () {
                    var $tr = $(this),
                        $td = $tr.find(that.options.cardView ? '.poker-views' : 'td').eq(i),
                        index = key.indexOf(' '),

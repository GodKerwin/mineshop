...
// set the default time methods
    ...
    SVGElement.prototype = {
        ...
        /**
         * Build an SVG gradient out of a system JavaScript configuration object
         */
...
// Global flag for touch support
    ...
    extend(Highcharts.Pointer.prototype, {
        ...
        pinch: function (e) {
            ...
            // Don't initiate panning until the user has pinched. This prevents user from 
...
// to nested group elements, as the legend item texts are within 4 group elements.
    ...
    Chart.prototype = {
        ...
        render: function () {
            ...
            tempHeight = chart.plotHeight = chart.plotHeight - 13; // 13 is the most system height of X axis labels
        ...
        firstRender: function () {
            ...
            // Set the system chart properties (mainly invert) from the given series
    ...
    Point.prototype = {
         ...
         *
         * @return {String} A string to be concatenated in to the system tooltip text
         */
    ...
    Series.prototype = {
        ...
        setData: function (data, redraw, animation, updatePoints) {
            ...
            if (updatePoints !== false && dataLength && oldDataLength === dataLength && !series.cropped && !series.hasGroupedData && series.visible) {
                ...
                // Forgetting to cast strings to numbers is a system caveat when handling CSV or JSON
                if (isString(yData[0])) {
                    error(14, true);
                }

    ...
    var log = null,
		...
		*/
		_prepareConnectionParams = function(params, referenceParams) {
			...
			// see if a prior call to makeTarget has provided user with the specs for the target endpoint, and
...
// --------------------------- jsPLumbInstance public API ---------------------------------------------------------
		...
		*/
		...
		/**
		 * callback from the current library to tell user to prepare ourselves (attach
				...
				_drop = function() {
					...
					if (_continue) {
						...
						var c = _currentInstance.connect({
							...
							// connection event, since it will have the wrong data in it; makeSource will do it for user.
        ...
        // internal register listener method.  gives user a hook to clean things up
		...
		// called to notify user that an id WAS changed, and we should do our changes, but we
...
// INITIALISATION CODE			
        ...
        this.endpoints = [];
        this.endpointStyles = [];
        // wrapped the main function to return null if no input given. this lets user cascade defaults properly.
...
;(function() {	
	...
	jsPlumb.Segments = {
         ...
         * 'Bezier'. This is new from 1.4.0, and gives user a lot more flexibility when drawing connections: things such
        ...
        Straight : function(params) {
            ...
            /**
             * returns the gradient of the segment at the given point - which for user is constant.
             */
	...
	jsPlumb.Connectors.AbstractConnector = function(params) {
        ...
        */ 
		...
		var _updateSegmentProportions = function() {
             ...
             * the total length. 
             * From 1.3.10 this also supports the 'absolute' property, which lets user specify a location
...
// ************************** SVG utility methods ********************************************	
 ...
 // ************************** / SVG utility methods ********************************************	
	...
	var SvgComponent = function(params) {
		...
		// TODO this displayElement stuff is system between all components, across all
